...
export const FIXTURE_ELIM = [
  // 32avos (M73–M88)
  {id:'r32_1', num:'M73',fase:'32avos',local:'2.A',     visita:'2.B',     fecha:'2026-07-01',hora:'16:00',estadio:'MetLife Stadium, Nueva York'},
  {id:'r32_2', num:'M74',fase:'32avos',local:'1.A',     visita:'3er T1',  fecha:'2026-07-01',hora:'20:00',estadio:'AT&T Stadium, Dallas'},
  {id:'r32_3', num:'M75',fase:'32avos',local:'1.F',     visita:'2.C',     fecha:'2026-07-02',hora:'16:00',estadio:'SoFi Stadium, Los Ángeles'},
  {id:'r32_4', num:'M76',fase:'32avos',local:'1.C',     visita:'2.F',     fecha:'2026-07-02',hora:'20:00',estadio:'Mercedes-Benz Stadium, Atlanta'},
  {id:'r32_5', num:'M77',fase:'32avos',local:'1.B',     visita:'3er T2',  fecha:'2026-07-03',hora:'16:00',estadio:'Gillette Stadium, Boston'},
  {id:'r32_6', num:'M78',fase:'32avos',local:'2.E',     visita:'2.I',     fecha:'2026-07-03',hora:'20:00',estadio:'Arrowhead Stadium, Kansas City'},
  {id:'r32_7', num:'M79',fase:'32avos',local:'1.D',     visita:'3er T3',  fecha:'2026-07-04',hora:'16:00',estadio:'BC Place, Vancouver'},
  {id:'r32_8', num:'M80',fase:'32avos',local:'1.E',     visita:'3er T4',  fecha:'2026-07-04',hora:'20:00',estadio:'NRG Stadium, Houston'},
  {id:'r32_9', num:'M81',fase:'32avos',local:'1.G',     visita:'3er T5',  fecha:'2026-07-05',hora:'16:00',estadio:'BMO Field, Toronto'},
  {id:'r32_10',num:'M82',fase:'32avos',local:'2.C',     visita:'2.D',     fecha:'2026-07-05',hora:'20:00',estadio:'Hard Rock Stadium, Miami'},
  {id:'r32_11',num:'M83',fase:'32avos',local:'2.K',     visita:'2.L',     fecha:'2026-07-06',hora:'16:00',estadio:'Lumen Field, Seattle'},
  {id:'r32_12',num:'M84',fase:'32avos',local:'1.H',     visita:'2.J',     fecha:'2026-07-06',hora:'20:00',estadio:'Lincoln Financial Field, Filadelfia'},
  {id:'r32_13',num:'M85',fase:'32avos',local:'1.I',     visita:'3er T6',  fecha:'2026-07-07',hora:'16:00',estadio:'AT&T Stadium, Dallas'},
  {id:'r32_14',num:'M86',fase:'32avos',local:'1.J',     visita:'2.H',     fecha:'2026-07-07',hora:'20:00',estadio:'MetLife Stadium, Nueva York'},
  {id:'r32_15',num:'M87',fase:'32avos',local:'1.L',     visita:'3er T7',  fecha:'2026-07-08',hora:'16:00',estadio:'SoFi Stadium, Los Ángeles'},
  {id:'r32_16',num:'M88',fase:'32avos',local:'2.D',     visita:'2.G',     fecha:'2026-07-08',hora:'20:00',estadio:'Mercedes-Benz Stadium, Atlanta'},
  // Octavos (M89–M96)
  {id:'r16_1', num:'M89',fase:'octavos',local:'G.M73',visita:'G.M74',fecha:'2026-07-11',hora:'16:00',estadio:'MetLife Stadium, Nueva York'},
  {id:'r16_2', num:'M90',fase:'octavos',local:'G.M75',visita:'G.M76',fecha:'2026-07-11',hora:'20:00',estadio:'AT&T Stadium, Dallas'},
  {id:'r16_3', num:'M91',fase:'octavos',local:'G.M77',visita:'G.M78',fecha:'2026-07-12',hora:'16:00',estadio:'SoFi Stadium, Los Ángeles'},
  {id:'r16_4', num:'M92',fase:'octavos',local:'G.M79',visita:'G.M80',fecha:'2026-07-12',hora:'20:00',estadio:'Mercedes-Benz Stadium, Atlanta'},
  {id:'r16_5', num:'M93',fase:'octavos',local:'G.M81',visita:'G.M82',fecha:'2026-07-13',hora:'16:00',estadio:'Gillette Stadium, Boston'},
  {id:'r16_6', num:'M94',fase:'octavos',local:'G.M83',visita:'G.M84',fecha:'2026-07-13',hora:'20:00',estadio:'Arrowhead Stadium, Kansas City'},
  {id:'r16_7', num:'M95',fase:'octavos',local:'G.M85',visita:'G.M86',fecha:'2026-07-14',hora:'16:00',estadio:'BC Place, Vancouver'},
  {id:'r16_8', num:'M96',fase:'octavos',local:'G.M87',visita:'G.M88',fecha:'2026-07-14',hora:'20:00',estadio:'NRG Stadium, Houston'},
  // Cuartos (M97–M100)
  {id:'qf1',num:'M97',fase:'cuartos',local:'G.M89',visita:'G.M90',fecha:'2026-07-18',hora:'16:00',estadio:'MetLife Stadium, Nueva York'},
  {id:'qf2',num:'M98',fase:'cuartos',local:'G.M91',visita:'G.M92',fecha:'2026-07-18',hora:'20:00',estadio:'AT&T Stadium, Dallas'},
  {id:'qf3',num:'M99',fase:'cuartos',local:'G.M93',visita:'G.M94',fecha:'2026-07-19',hora:'16:00',estadio:'SoFi Stadium, Los Ángeles'},
  {id:'qf4',num:'M100',fase:'cuartos',local:'G.M95',visita:'G.M96',fecha:'2026-07-19',hora:'20:00',estadio:'Mercedes-Benz Stadium, Atlanta'},
  // Semis (M101–M102)
  {id:'sf1',num:'M101',fase:'semis',local:'G.M97',visita:'G.M98',fecha:'2026-07-22',hora:'20:00',estadio:'MetLife Stadium, Nueva York'},
  {id:'sf2',num:'M102',fase:'semis',local:'G.M99',visita:'G.M100',fecha:'2026-07-23',hora:'20:00',estadio:'SoFi Stadium, Los Ángeles'},
  // Tercer lugar (M103)
  {id:'3p', num:'M103',fase:'tercero',local:'Perd.M101',visita:'Perd.M102',fecha:'2026-07-25',hora:'16:00',estadio:'AT&T Stadium, Dallas'},
  // Final (M104)
  {id:'fin',num:'M104',fase:'final',local:'G.M101',visita:'G.M102',fecha:'2026-07-26',hora:'20:00',estadio:'MetLife Stadium, Nueva York'},
];
